...
//  TFLC02_Init();
  ...
  while (1)
  {
	//Se refresca el estado del pulsador
	debounceFSM_update();
...
//		Se mide la distancia
	...
	//Se revisa si la medicion esta completa
	...
	//Si el usuario cambio la frecuencia de sampleo se refresca la infomacion y se muestra en el displey
...
//	Si se presiona el boton, cambia la frecuencia de muestreo
	if(readPushed()){
